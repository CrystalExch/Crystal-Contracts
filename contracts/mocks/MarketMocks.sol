...
contract ToggleMarket {
    ...
    function marketOrder(bool, bool, uint256, uint256, uint256 size, uint256, address, address)
        external
        payable
...
contract ReplaceOrderMarket {
    ...
    function replaceOrder(uint256, uint256, uint256, uint256, uint256, address, address)
        external
        payable
        returns (uint256)
    {
...
contract MaliciousMarket {
    function getQuote(bool, bool, bool, uint256 size, uint256)
        external
        pure
...
contract FailingMarket {
    ...
    function marketOrder(bool, bool, uint256, uint256, uint256, uint256, address, address)
        external
        payable
        returns (uint256, uint256, uint256)
    {
...
contract InconsistentQuoteMarket {
    function getQuote(bool, bool, bool useInternalBalance, uint256 size, uint256)
        external
        pure
        returns (uint256 inputAmount, uint256 outputAmount)
    {
...
contract FailingQuoteMarket {
    function getQuote(bool, bool, bool, uint256, uint256) external pure returns (uint256, uint256) {
        assembly {
            revert(0, 0)
        }
    }
