...
contract QuoteTest is BaseTest {
    function testGetQuoteReadsRestingAskLiquidity() public {
    ...
    function testGetQuoteReadsAmmLiquidity() public {
        uint256 reserveQuote = 100_000 * QUOTE_UNIT;
        uint256 reserveBase = 100 ether;
    ...
    function testGetAmountsOutMatchesDirectBuyQuote() public {
        uint256 price = _price(500);
        uint256 askSize = 10 ether;
        uint256 quoteIn = 2_500 * QUOTE_UNIT;
    ...
    function testGetAmountsInMatchesDirectBuyQuote() public {
        uint256 price = _price(500);
        uint256 askSize = 10 ether;
        uint256 desiredBaseOut = 2 ether;
